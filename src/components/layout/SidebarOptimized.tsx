...
import LogoutConfirmModalOptimized from "../common/LogoutConfirmModalOptimized";
import "./Sidebar.css";
...
const SidebarOptimized: React.FC<SidebarProps> = ({ active }) => {
