...
const OptimizedHeader: React.FC = () => {
  ...
  ), [searchTerm, handleSearchChange, handleClearSearch]);

  const renderCreditsSection = useMemo(() => (
  ...
  ), [renderCreditsSection, renderUserSection]);
...
export default React.memo(OptimizedHeader); 