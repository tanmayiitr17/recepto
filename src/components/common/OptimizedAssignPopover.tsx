...
interface OptimizedAssignPopoverProps {
  isOpen: boolean;
  onClose: () => void;
  users: User[];
...
const OptimizedAssignPopover: React.FC<OptimizedAssignPopoverProps> = ({
  isOpen,
  onClose,
  users,
  onAssign,
...
export default React.memo(OptimizedAssignPopover); 